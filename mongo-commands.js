...
//   db.movies.find({rating:{$gt:8}}).pretty()
  ...
  // //exclusion
  // db.movies.find({},{trailer:0,summary:0}).pretty()

  // //❌
  // db.movies.find({},{trailer:0,rating:1}).pretty()
  ...
  //   //mySQL
  //   SELECT productName AS _Id,SUM(qunatity) AS totalUrgentQuantity FROM orders
  //   WHERE status="urgent"
